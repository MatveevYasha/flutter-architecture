...
class _$MainLoadingState
    with DiagnosticableTreeMixin
    implements MainLoadingState {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty('type', 'MainBlocState.loading'));
  }
...
class _$MainLoadedState
    with DiagnosticableTreeMixin
    implements MainLoadedState {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'MainBlocState.loaded'))
...
class _$_MainInitEvent with DiagnosticableTreeMixin implements _MainInitEvent {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties.add(DiagnosticsProperty('type', 'MainBlocEvent.init'));
  }
...
class _$_MainSetEvent with DiagnosticableTreeMixin implements _MainSetEvent {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'MainBlocEvent.setUser'))
